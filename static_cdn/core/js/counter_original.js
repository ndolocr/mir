...
function calculate_cell_one_low(val){
	...
	if(cell_width<=1){
		...
		cell_width = 20;
	}else if(cell_width<=25){
		cell_width = 25;
	}else if(cell_width<=30){
		cell_width = 30;
	}else if(cell_width<=35){
		cell_width = 35;
	}else if(cell_width<=40){
		cell_width = 40;
	}else if(cell_width<=45){
		cell_width = 45;
	}else if(cell_width<=50){
		cell_width = 50;
	}else if(cell_width<=55){
		cell_width = 55;
	}else if(cell_width<=60){
		cell_width = 60;
	}else if(cell_width<=65){
		cell_width = 65;
	}else if(cell_width<=70){
		cell_width = 70;
	}else if(cell_width<=75){
		cell_width = 75;
	}else if(cell_width<=80){
		cell_width = 80;
	}else if(cell_width<=85){
		cell_width = 85;
	}else if(cell_width<=90){
		cell_width = 90;
	}else if(cell_width<=95){
		cell_width = 95;
	}else if(cell_width<=100){
		cell_width = 100;
	}	
